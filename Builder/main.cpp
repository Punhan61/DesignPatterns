...
public:
	...
	void set_disk()
	{
		computer->set_disk("Samsung 750 Evo 250GB");
	}
	void set_power()
	{
...
{
	setlocale(LC_ALL, "");
	//Computer comp("Core i5 12400", "Kingston 8GB", "Intel HD Graphics", "Sumsung 870 Evo 500 GB", "Chieftec 500 Gold");
	//comp.info();
	Sysadmin nice_guy;
